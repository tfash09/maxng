...
import SearchIcon from '@material-ui/icons/Search';
  ...
  const headCells = [
    ...
    { id: 'Model', numeric: false, disablePadding: false, label: 'Vehicle Model' },
    { id: 'Class', numeric: false, disablePadding: false, label: 'Vehicle Class' },
    { id: 'Manufacturer', numeric: false, disablePadding: false, label: 'Vehicle Manufacturer' },
    { id: 'Length', numeric: true, disablePadding: false, label: 'Vehicle Length' },
    { id: 'Passengers', numeric: false, disablePadding: false, label: 'Passengers' },
    { id: 'Crew', numeric: true, disablePadding: false, label: 'Crew' },
    { id: 'Capacity', numeric: true, disablePadding: false, label: 'Cargo Capacity' },
  ];
...
const Vehicles = () => {
    ...
    const fetchData = async () => {
        try {
            setLoader(true);
            const starships = await fetchJSON('vehicles/', null, 'GET');
            setLoader(false);
                            ...
                            <InputBase
                                ...
                                onChange={(e) => {
                                    ...
                                    if(val === '' || val === null){
                                        ...
                                        let temp = starshipsData.filter(data => (data.name.indexOf(val) !== -1 || data.model.indexOf(val) !== -1 || data.vehicle_class.indexOf(val) !== -1 ))  
                                        setStarships(temp);
