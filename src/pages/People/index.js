...
import SearchIcon from '@material-ui/icons/Search';
  ...
  const headCells = [
    ...
    { id: 'year', numeric: false, disablePadding: false, label: 'Birth year' },
    { id: 'Gender', numeric: false, disablePadding: false, label: 'Gender' },
    { id: 'Eye', numeric: false, disablePadding: false, label: 'Eye color' },
    { id: 'Hair', numeric: true, disablePadding: false, label: 'Hair color' },
    { id: 'Height', numeric: false, disablePadding: false, label: 'Height' },
    { id: 'Skin', numeric: true, disablePadding: false, label: 'Skin color' },
                            ...
                            <InputBase
                                ...
                                onChange={(e) => {
                                    ...
                                    if(val === '' || val === null){
                                        ...
                                        let temp = starshipsData.filter(data => (data.name.indexOf(val) !== -1))  
                                        setStarships(temp);
                                                ...
                                                .map((row, index) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <TableCell align="right" style={{color: '#168865'}}>{row.created}</TableCell>
                                                        </TableRow>
                                                    );
                                                })}
                                            {emptyRows > 0 && (
