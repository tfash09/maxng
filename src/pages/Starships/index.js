...
import SearchIcon from '@material-ui/icons/Search';
  ...
  const headCells = [
    ...
    { id: 'Cost', numeric: false, disablePadding: false, label: 'Cost (in GC)' },
    { id: 'Passengers', numeric: true, disablePadding: false, label: 'Passengers' },
                            ...
                            <InputBase
                                ...
                                onChange={(e) => {
                                    ...
                                    if(val === '' || val === null){
                                        ...
                                        let temp = starshipsData.filter(data => (data.name.indexOf(val) !== -1 || data.model.indexOf(val) !== -1 ))  
                                        setStarships(temp);
